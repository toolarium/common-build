...
if not defined CB_BTRACE_VERSION set "CB_BTRACE_VERSION=2.2.3"
...
set "CB_PACKAGE_DOWNLOAD_NAME=btrace-v%CB_PACKAGE_VERSION%-bin.zip"
set "CB_PACKAGE_VERSION_NAME=btrace-v%CB_PACKAGE_VERSION%"
