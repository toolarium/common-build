...
CB_PACKAGE_DOWNLOAD_URL=https://api.adoptopenjdk.net/v2/binary/releases/openjdk$CB_PACKAGE_VERSION?openjdk_impl=$CB_JAVA_OPENJDK_IMPL&os=$CB_OS&arch=x$CB_PROCESSOR_ARCHITECTURE_NUMBER&release=latest&type=jdk
CB_PACKAGE_BASE_URL=
