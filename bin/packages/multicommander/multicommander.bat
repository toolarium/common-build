...
set "CB_PACKAGE_DOWNLOAD_URL=https://multicommander.com/files/updates/MultiCommander_x%CB_PROCESSOR_ARCHITECTURE_NUMBER%_Portable_(%CB_PACKAGE_VERSION%).zip"
