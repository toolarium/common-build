...
if not defined CB_PYTHON_VERSION set "CB_PYTHON_VERSION=3.14.6"
...
set "CB_PACKAGE_DIRECTORY_NAME=%CB_DEVTOOLS%\python-%CB_PACKAGE_VERSION%"
if .%CB_INSTALL_OVERWRITE_DIST%==.false if exist %CB_PACKAGE_DIRECTORY_NAME% set "CB_PACKAGE_ALREADY_EXIST=true"
set "CB_POST_INSTALL_ACTION=call %CB_SCRIPT_PATH%packages\python\install-pip.bat"
