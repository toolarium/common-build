...
if .%1==.cleanup-start shift & goto CUSTOM_CLEANUP_START
if .%1==.cleanup-end shift & goto CUSTOM_CLEANUP_END
...
set "CB_CUSTOM_PROJECT_CONFIGFILE=%CB_TEMP%\cb-project-types-custom-%RANDOM%%RANDOM%.tmp"
...
:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
echo %CB_LINEHEADER%START CLEANUP %1 %2 %3 %4 %5 %6 %7 %8 %9
goto CUSTOM_END
...
:CUSTOM_CLEANUP_END
:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
echo %CB_LINEHEADER%END CLEANUP %1 %2 %3 %4 %5 %6 %7 %8 %9
goto CUSTOM_END
