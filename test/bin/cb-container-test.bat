...
echo call "!CT!" --scan testproject -a >> "!CRTMPDIR!\run.bat"
...
echo call "!CT!" --scan testproject -a >> "!CDTMPDIR!\run.bat"
...
echo call "!CT!" --scan testproject -a >> "!CNTMPDIR!\run.bat"
...
echo call "!CT!" --scan testproject -a --force >> "!CFTMPDIR!\run.bat"
